 ...
 * @package DAO
 */
public class PatientPaneDaoForTest {
    ...
    public String getInfoUtente(String username) {
        ...
        try(Connection conn = DBConnection.getConnection();
            ...
            System.out.println( "Errore caricamento dati " + "Si è verificato un errore nel caricamento dei dati del paziente");
            e.printStackTrace();
        }
        return null ;
    }
    ...
    public void updateInfoUtente(String username, String nuoveNote) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            System.out.println("Successo" + "Le informazioni utente sono state aggiornate.");
        } catch (SQLException ex) {
            System.out.println( "Errore" + "Errore durante il salvataggio delle modifiche.");
            ex.printStackTrace();
        }
    }
